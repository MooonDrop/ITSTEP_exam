            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        ...
                        <div class="icon">
                            <i class="mr-3 fa-solid fa-hashtag"></i>
                        </div>
                        <a href="{{ route('admin.tag.index') }}" class="small-box-footer">More info<i class="ml-1 fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        ...
                        <div class="icon">
                            <i class="mr-3 fa-regular fa-clipboard"></i>
                        </div>
