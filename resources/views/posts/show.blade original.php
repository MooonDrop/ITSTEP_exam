                        ...
                        <li class="post-list__item popular-posts">
                            <article class="blog-post popular-posts__article">
                                ...
                                <ul class="blog-post__action-list">
                                    <li class="blog-post__action-list-item">
                                        <form class="blog-post__like-form"
                                            action="{{ route('post.like.store', $relatedPost->id) }}" method="post">
                                            @csrf
                                            <button class="blog-post__icon blog-post__icon--likes">
                                                <i
                                                    class="fa-{{ auth()->user()->likedPosts->contains($relatedPost->id) ? 'solid' : 'regular' }} fa-heart"></i>
                                                {{ $relatedPost->likedUsers->count() }}
                                            </button>
                                        </form>
                                    </li>
                                </ul>
